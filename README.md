# Calamus3 — Next.js + Supabase

Self-hosted port of the Base44 HeyChat prototype (renamed Calamus3 on
...
until Calamus3 is added to the home screen. The Settings panel says so.
